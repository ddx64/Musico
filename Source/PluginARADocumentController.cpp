...
//==============================================================================
juce::ARAPlaybackRenderer* MusicoDocumentController::doCreatePlaybackRenderer() noexcept
{
    return new MusicoPlaybackRenderer (getDocumentController());
}

//==============================================================================
bool MusicoDocumentController::doRestoreObjectsFromStream (juce::ARAInputStream& input, const juce::ARARestoreObjectsFilter* filter) noexcept
{
...
bool MusicoDocumentController::doStoreObjectsToStream (juce::ARAOutputStream& output, const juce::ARAStoreObjectsFilter* filter) noexcept
{
...
{
    return juce::ARADocumentControllerSpecialisation::createARAFactory<MusicoDocumentController>();
}
